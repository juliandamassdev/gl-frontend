    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            Utilize the search bar to find specific collections, NFTs, or projects within your user profile. Enter
            keywords to access relevant results, making it easy and saving time as you explore your digital collections.
          </p>
        </div>
        <div className="space-y-5">
          <Image
            src="/images/docs/user-profile-search-bar-1.png"
            width="700"
            height="700"
            alt="Docs"
