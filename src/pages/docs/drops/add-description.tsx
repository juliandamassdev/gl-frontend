    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            Providing a detailed description or additional information about the NFT can enhance its appeal to potential
            buyers.
          </p>
          <Image
            src="/images/docs/drops-add-description-1.png"
            width="700"
            height="700"
            alt="Docs"
