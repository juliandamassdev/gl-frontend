    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            Located at the top right corner of the Configure Item Page, this button allows users to return to the main
            Drops Page without saving changes, providing flexibility during the editing process.
          </p>
          <Image
            src="/images/docs/drops-x-button-1.png"
            width="700"
            height="700"
            alt="Docs"
