    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            On the left side of the screen is the NFT image being edited. Users can see the item they&apos;re
            configuring and make real-time changes.
          </p>
          <Image
            src="/images/docs/drops-nft-image-1.png"
            width="700"
            height="700"
            alt="Docs"
