    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            This detailed documentation provides a comprehensive overview of the Drops Tool within the NFT No-Code Tool
            Dashboard. It guides you through the process of creating NFT drops and configuring individual items for your
            collections. If you have any questions or need further assistance, please refer to the platform&apos;s
            support resources or contact customer support for help.
          </p>
        </div>
      </div>
    </DocsLayout>
