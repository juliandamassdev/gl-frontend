    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            Users can add custom traits or properties for each character or NFT image. These properties add uniqueness
            and character to the collection.
          </p>
          <Image
            src="/images/docs/drops-add-properties-1.png"
            width="700"
            height="700"
            alt="Docs"
