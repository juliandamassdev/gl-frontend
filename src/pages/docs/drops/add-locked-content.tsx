...
const Docs = () => {
  ...
  return (
    <DocsLayout navMenu={navMenu}>
      <h2>Add Locked Content</h2>
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            Locked content can be added, specifying what buyers will gain access to upon purchasing the NFT or under
            specific conditions.
          </p>
          <Image
            src="/images/docs/drops-add-locked-content-1.png"
            width="700"
            height="700"
            alt="Docs"
