...
const Docs = () => {
  ...
  return (
    <DocsLayout navMenu={navMenu}>
      <h2>Configure an Item</h2>
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            To edit individual items, users can hover over the NFT image within the Drops collection. Clicking the
            &quot;Gear&quot; icon opens the Configure Item Page, enabling detailed customization.
          </p>
          <Image
            src="/images/docs/drops-configure-an-item-1.png"
            width="700"
            height="700"
            alt="Docs"
        ...
        <div className="space-y-5">
          <Image
            src="/images/docs/drops-configure-an-item-2.png"
            width="700"
            height="700"
            alt="Docs"
            className="w-[676px] rounded"
