    ...
    <DocsLayout navMenu={navMenu}>
      ...
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            The header section provides easy access to the user&apos;s profile and the &quot;Deploy&quot; button. The
            &quot;Deploy&quot; button finalizes and launches the NFT drop once the project is complete.
          </p>
          <Image
            src="/images/docs/drops-header-1.png"
            width="700"
            height="700"
            alt="Docs"
