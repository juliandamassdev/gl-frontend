...
const Docs = () => {
  ...
  return (
    <DocsLayout navMenu={navMenu}>
      <h2>Uploading Artwork and Metadata</h2>
      <div className="space-y-12">
        <div className="space-y-5">
          <p>
            The next phase of the process is uploading your artwork and metadata files. Follow these steps to do it
            correctly:
          </p>
        </div>
        <div className="space-y-5">
          ...
          <Image
            src="/images/docs/art-generator-uploading-artwork-and-metadata-1.png"
            width="700"
            height="700"
            alt="Docs"
        ...
        <div className="space-y-5">
          ...
          <p>The progress of the upload will be shown to keep you informed.</p>
          <Image
            src="/images/docs/art-generator-uploading-artwork-and-metadata-2.png"
            width="700"
            height="700"
            alt="Docs"
            className="w-[676px] rounded"
        ...
        <div className="space-y-5">
          ...
          <p>Toggle the pages you want to proceed to in the next steps.</p>
          <Image
            src="/images/docs/art-generator-uploading-artwork-and-metadata-3.png"
            width="700"
            height="700"
            alt="Docs"
            className="w-[676px] rounded"
